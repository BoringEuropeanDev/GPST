...
# SQLite doesn't support pool_size/max_overflow — use NullPool instead
if IS_SQLITE:
...
class Prediction(Base):
    ...
    target_date          = Column(DateTime, index=True, nullable=False)   # added index
    ...
    was_correct          = Column(Boolean, index=True)   # added index
