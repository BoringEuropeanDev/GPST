...
const Header = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      if (isWeekday && totalMins >= 570 && totalMins < 960) {
        setMarketStatus('OPEN');
      } else if (isWeekday && (
        (totalMins >= 240 && totalMins < 570) ||   // pre-market  4:00–9:30 ET
        (totalMins >= 960 && totalMins < 1200)      // after-hours 16:00–20:00 ET
      )) {
    ...
    <header style={styles.header}>
      <div style={styles.inner}>
        ...
        <div style={styles.centerStats}>
          ...
          <div style={styles.statItem}>
            ...
            <span style={{ ...styles.statVal, color: 'var(--accent-purple)' }}>ML v2.0</span>
          </div>
        </div>
      ...
      <div style={styles.terminalBar}>
        ...
        <span style={{ marginLeft: 8, color: 'var(--text-muted)' }}>
          sys://gpst.terminal v2.0.0 — All predictions are informational only.
